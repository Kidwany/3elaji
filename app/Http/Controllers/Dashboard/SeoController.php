...
class SeoController extends Controller
{
    ...
    public function websitePages()
    {
        ...
        }elseif($pageType == 'clinics')
        {
            $pages = Page::all();
            return view('dashboard.seo.clinicPage.clinicsPages', compact('pages'));
        }
    ...
    public function editClinicPage($id)
    {
        $clinic = Page::with('open_graph')->find($id);
        return view('dashboard.seo.clinicPage.editPages', compact('page'));
    }
    ...
    public function openGraph()
    {
        ...
        elseif ($openGraphType == 'clinics')
        {
            $pages = Page::with('clinic')->get();
            return view('dashboard.seo.clinicOpenGraph.clinicsPagesOpenGraph', compact('pages'));
        }
    ...
    public function editClinicsPagesOpenGraph($id)
    {
        return view('dashboard.seo.clinicOpenGraph.editClinicOpenGraph', compact('pages'));
    }
