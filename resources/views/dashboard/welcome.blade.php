            ...
            <div class="shortcuts-section">
                ...
                <div class="section-body">
                    <ul>
                        ...
                        <li>
                            <a href="{{adminUrl('clinic/create')}}">
                                <div class="li-img">
                                    <img src="{{asset('dashboard/img/shortcuts/customer.png')}}" alt="img">
                                </div>
                                <div class="li-title">
                                    <p>
                                        Add Clinic
                        ...
                        <li>
                            <a href="{{adminUrl('spetialist/create')}}">
                                <div class="li-img">
                                    <img src="{{asset('dashboard/img/shortcuts/shopping-cart.png')}}" alt="img">
                                </div>
                                <div class="li-title">
                                    <p>
                                        Add Speciality
